...
import { listAllPermissions, listCustomers } from "@/lib/dynamodb";
...
export default async function TeamAccessPage() {
  ...
  const [permissions, customers] = await Promise.all([
    listAllPermissions(),
    listCustomers(),
  ]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-zinc-950">
      ...
      <main className="max-w-5xl mx-auto px-5 py-8">
        ...
        <UserPermissionsPanel permissions={permissions} customers={customers} />
      </main>
    </div>
  );
}
